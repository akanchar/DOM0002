...
document.addEventListener('DOMContentLoaded', function () {
    ...
    paintingsData.forEach(painting => {
        ...
        listItem.innerHTML = `<img src="images/large/${painting.id}.jpg" data-id="${painting.id}" alt="${painting.title}" class="thumbnail">`; // Adds thumbnail images with the corresponding data-id
